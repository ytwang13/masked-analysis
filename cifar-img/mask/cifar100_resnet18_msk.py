...
param_scheduler2 =  dict(
    type='MultiStepLR', by_epoch=True, milestones=[35, 45, 55], gamma=0.1)


# train, val, test setting
train_cfg = dict(type='CLEpochTrainLoop', max_epochs=50, max_task=num_task, val_interval=10) #, val_interval=1
