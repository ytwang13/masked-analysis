...
optim_wrapper = dict(
    ...
    optimizer=dict(type='SGD', lr=0.1, momentum=0.9, weight_decay=0.0001),# 42 -82 util
    # backbone=dict(type='OptimWrapper', optimizer=dict(type='SGD', lr=0.3, momentum=0.9, weight_decay=0.0001)),
    # head=dict(type='OptimWrapper', optimizer=dict(type='SGD', lr=0.3, momentum=0.9, weight_decay=0.0001)),
)
# learning policy
