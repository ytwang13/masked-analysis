...
optim_wrapper2 = dict(
    ...
    paramwise_cfg=dict(custom_keys={'backbone': dict(lr_mult=0.3)})
    )
...
# train, val, test setting
train_cfg = dict(type='CLEpochTrainLoop', max_epochs=30, max_task=num_task, val_interval=10) #, val_interval=1
...
default_hooks = dict(
    ...
    checkpoint=dict(type='CLCheckpointHook', interval=999, max_keep_ckpts=1),
