...
default_hooks = dict(
    ...
    checkpoint=dict(type='CheckpointHook', interval=999, max_keep_ckpts=3),
...
# vis_backends = dict(type='WandbVisBackend', init_kwargs=dict(project='msk_exp',id='followexpname',group="cebase"))
####### TO activate wandb uncomment above and install and configure your wandb in your environment
