...
# set visualizer
# vis_backends = dict(type='WandbVisBackend', init_kwargs=dict(project='msk_exp',id='followexpname',group="mskclso"))
vis_backends = dict(type='WandbVisBackend', init_kwargs=dict(project='test_config',id='mskmoderatio_v',group="msknoinvfull"))#msk_full
##################################################################### msk_exp
