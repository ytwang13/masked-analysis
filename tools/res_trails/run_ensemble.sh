...
python tools/train.py /--your-own-dir/cifar-img/dl_res18_exp/ensemble/cifar10_resnet18_c40_distill.py
--cfg-options work_dir='/-yourdirectory-/out/dl/res18-c10/cifarbase/ensemble/all'



################ step1: random seeds to ensemble
python tools/train.py /--your-own-dir/cifar-img/dl_res18_exp/ensemble/cifar10_resnet18_c40_seed.py \
