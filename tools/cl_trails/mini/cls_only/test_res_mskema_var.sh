...
mask_ratio=${1:-0.13}
inv_mode=${2:-'v2'}
emaratio=${3:-0.1} # here not incorperated in the following?
mask_mode=${4:-'a'}
...
python tools/train.py /--your-own-dir/cifar-img/dl_res18_exp/cifar10_resnet18_c40_complemaskema.py \
--cfg-options model.head.mask_mode=$mask_mode model.head.mask_inv=True model.head.mask_ratio=$mask_ratio  model.head.loss_weight=7.0 model.head.inv_mode=$inv_mode default_hooks.emahook.momentum=$emaratio  work_dir='/scratch/yw6594/cf/out/dl/res18-c10/cifarbase/c40/conv3x3/maskinvoldv2/CSmaskweightwandb'${mask_mode}'/'${emaratio}'_'${mask_ratio}'/7.0'

python tools/train.py /--your-own-dir/cifar-img/dl_res18_exp/cifar10_resnet18_c40_complemaskema.py \
--cfg-options model.head.mask_mode=$mask_mode model.head.mask_inv=True model.head.mask_ratio=$mask_ratio  model.head.loss_weight=5.0 model.head.inv_mode=$inv_mode default_hooks.emahook.momentum=$emaratio  work_dir='/scratch/yw6594/cf/out/dl/res18-c10/cifarbase/c40/conv3x3/maskinvoldv2/CSmaskweightwandb'${mask_mode}'/'${emaratio}'_'${mask_ratio}'/5.0'

python tools/train.py /--your-own-dir/cifar-img/dl_res18_exp/cifar10_resnet18_c40_complemaskema.py \
--cfg-options model.head.mask_mode=$mask_mode model.head.mask_inv=True model.head.mask_ratio=$mask_ratio  model.head.loss_weight=1.0 model.head.inv_mode=$inv_mode default_hooks.emahook.momentum=$emaratio  work_dir='/scratch/yw6594/cf/out/dl/res18-c10/cifarbase/c40/conv3x3/maskinvoldv2/CSmaskweightwandb'${mask_mode}'/'${emaratio}'_'${mask_ratio}'/1.0'

python tools/train.py /--your-own-dir/cifar-img/dl_res18_exp/cifar10_resnet18_c40_complemaskema.py \
--cfg-options model.head.mask_mode=$mask_mode model.head.mask_inv=True model.head.mask_ratio=$mask_ratio  model.head.loss_weight=0.5 model.head.inv_mode=$inv_mode default_hooks.emahook.momentum=$emaratio  work_dir='/scratch/yw6594/cf/out/dl/res18-c10/cifarbase/c40/conv3x3/maskinvoldv2/CSmaskweightwandb'${mask_mode}'/'${emaratio}'_'${mask_ratio}'/0.5'

python tools/train.py /--your-own-dir/cifar-img/dl_res18_exp/cifar10_resnet18_c40_complemaskema.py \
--cfg-options model.head.mask_mode=$mask_mode model.head.mask_inv=True model.head.mask_ratio=$mask_ratio  model.head.loss_weight=0.3 model.head.inv_mode=$inv_mode default_hooks.emahook.momentum=$emaratio  work_dir='/scratch/yw6594/cf/out/dl/res18-c10/cifarbase/c40/conv3x3/maskinvoldv2/CSmaskweightwandb'${mask_mode}'/'${emaratio}'_'${mask_ratio}'/0.3'

python tools/train.py /--your-own-dir/cifar-img/dl_res18_exp/cifar10_resnet18_c40_complemaskema.py \
--cfg-options model.head.mask_mode=$mask_mode model.head.mask_inv=True model.head.mask_ratio=$mask_ratio  model.head.loss_weight=0.1 model.head.inv_mode=$inv_mode default_hooks.emahook.momentum=$emaratio  work_dir='/scratch/yw6594/cf/out/dl/res18-c10/cifarbase/c40/conv3x3/maskinvoldv2/CSmaskweightwandb'${mask_mode}'/'${emaratio}'_'${mask_ratio}'/0.1'

python tools/train.py /--your-own-dir/cifar-img/dl_res18_exp/cifar10_resnet18_c40_complemaskema.py \
--cfg-options model.head.mask_mode=$mask_mode model.head.mask_inv=True model.head.mask_ratio=$mask_ratio  model.head.loss_weight=0.090 model.head.inv_mode=$inv_mode default_hooks.emahook.momentum=$emaratio  work_dir='/scratch/yw6594/cf/out/dl/res18-c10/cifarbase/c40/conv3x3/maskinvoldv2/CSmaskweightwandb'${mask_mode}'/'${emaratio}'_'${mask_ratio}'/0.090'

python tools/train.py /--your-own-dir/cifar-img/dl_res18_exp/cifar10_resnet18_c40_complemaskema.py \
--cfg-options model.head.mask_mode=$mask_mode model.head.mask_inv=True model.head.mask_ratio=$mask_ratio  model.head.loss_weight=0.050 model.head.inv_mode=$inv_mode default_hooks.emahook.momentum=$emaratio  work_dir='/scratch/yw6594/cf/out/dl/res18-c10/cifarbase/c40/conv3x3/maskinvoldv2/CSmaskweightwandb'${mask_mode}'/'${emaratio}'_'${mask_ratio}'/0.050'

python tools/train.py /--your-own-dir/cifar-img/dl_res18_exp/cifar10_resnet18_c40_complemaskema.py \
--cfg-options model.head.mask_mode=$mask_mode model.head.mask_inv=True model.head.mask_ratio=$mask_ratio  model.head.loss_weight=0.030 model.head.inv_mode=$inv_mode default_hooks.emahook.momentum=$emaratio  work_dir='/scratch/yw6594/cf/out/dl/res18-c10/cifarbase/c40/conv3x3/maskinvoldv2/CSmaskweightwandb'${mask_mode}'/'${emaratio}'_'${mask_ratio}'/0.030'

python tools/train.py /--your-own-dir/cifar-img/dl_res18_exp/cifar10_resnet18_c40_complemaskema.py \
--cfg-options model.head.mask_mode=$mask_mode model.head.mask_inv=True model.head.mask_ratio=$mask_ratio  model.head.loss_weight=0.010 model.head.inv_mode=$inv_mode default_hooks.emahook.momentum=$emaratio  work_dir='/scratch/yw6594/cf/out/dl/res18-c10/cifarbase/c40/conv3x3/maskinvoldv2/CSmaskweightwandb'${mask_mode}'/'${emaratio}'_'${mask_ratio}'/0.010'
