########## res50
### depth 0 1 2 
# python tools/train.py /--your-own-dir/cifar-img/cifar100/cifar100_resnet18_naive.py \
# --cfg-options model.head.mid_channels=None work_dir='/scratch/yw6594/out/cl_test/cifar100_toy/t5lr_mulWN/res18_d0'

# python tools/train.py /--your-own-dir/cifar-img/cifar100/cifar100_resnet50_naive.py \
