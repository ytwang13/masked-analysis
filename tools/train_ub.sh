...
### res50_cifar100
# python tools/train.py /scratch/yw6594/cf/mmcl/cifar-img/draft/cifar100_resnet18_optims.py \
# --cfg-options work_dir='/scratch/yw6594/out/cl_test/cifar100_ub/res18_ep200'

# python tools/train.py /scratch/yw6594/cf/mmcl/cifar-img/draft/cifar100_resnet50.py \
...
# ### res18_cifar100
# python tools/train.py /scratch/yw6594/cf/mmcl/cifar-img/cifar10_resnet18_optims.py \
