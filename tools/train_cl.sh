# python tools/train.py /scratch/yw6594/cf/mmcl/cifar-img/cifar100_resnet18.py \
...
########## EP 50
# python tools/train.py /scratch/yw6594/cf/mmcl/cifar-img/cifar_resnet18_cltest.py \
...
# python tools/train.py /scratch/yw6594/cf/mmcl/cifar-img/cifar_resnet18_cltestt5.py \
