...
def merge_args(cfg, args):
    ...
    try:
        if cfg.vis_backends.type == 'WandbVisBackend':
            cfg.visualizer.vis_backends.init_kwargs.id=cfg.expname+cfg.visualizer.vis_backends.init_kwargs.group
        # or vis_backends[-1].type == 'WandbVisBackend':
    except:
        if cfg.vis_backends[-1].type == 'WandbVisBackend':
            cfg.visualizer.vis_backends[-1].init_kwargs.id=cfg.expname+cfg.visualizer.vis_backends.init_kwargs.group
