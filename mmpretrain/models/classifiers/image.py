...
import copy
@MODELS.register_module()
class CLImageClassifier(BaseClassifier):
    """Image classifiers for supervised classification task.
    ...
    def __init__(self,
        ...
        super(CLImageClassifier, self).__init__(
            init_cfg=init_cfg, data_preprocessor=data_preprocessor)
    ...
    def loss(self, cllogits: torch.Tensor, 
        ...
        """
        feats = self.extract_feat(inputs)
        return self.head.loss(cllogits, feats, data_samples)
